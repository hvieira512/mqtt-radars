...
$generalKPIs = [
    ['label' => 'Duração de Sono', 'value' => '0', 'unit' => 'h', 'meta' => '<span class="text-success"><i class="fa-solid fa-circle-check"></i> Conformidade</span>', 'metaId' => 'sleep-duration-meta', 'icon' => 'fa-clock', 'color' => 'success', 'id' => 'general-sleep-duration', 'statId' => 'general-sleep-duration-value', 'tooltip' => 'Método estatístico: duração do sono profundo + duração do sono leve'],
    ['label' => 'Saídas da Cama', 'value' => '0', 'unit' => 'vezes', 'meta' => '<span class="text-success"><i class="fa-solid fa-circle-check"></i> Conformidade</span>', 'metaId' => 'leave-bed-meta', 'icon' => 'fa-bed', 'color' => 'danger', 'id' => 'leave-bed', 'statId' => 'leave-bed-value', 'tooltip' => 'Método estatístico: do início do sono ao despertar, horas de saída da cama'],
    ['label' => 'Percentagem de Sono Profundo %', 'value' => '0', 'unit' => '%', 'meta' => '<span class="text-danger"><i class="fa-solid fa-circle-xmark"></i> Não Conformidade</span>', 'metaId' => 'deep-sleep-percentage-meta', 'icon' => 'fa-brain', 'color' => 'danger', 'id' => 'deep-sleep-percentage', 'statId' => 'deep-sleep-percentage-value', 'tooltip' => 'Método estatístico: duração do sono profundo / duração do sono'],
    ['label' => 'AHI', 'value' => '0', 'unit' => '', 'meta' => '<span class="text-success"><i class="fa-solid fa-circle-check"></i> Conformidade</span>', 'metaId' => 'ahi-meta', 'icon' => ' fa-lungs', 'color' => 'success', 'id' => 'ahi', 'statId' => 'ahi-value', 'tooltip' => 'Método estatístico: Número médio de apneias por hora IAH < 5, normal 5 < IAH ≤ 15, ligeiro 15 < IAH ≤ 30, moderada IAH > 30, grave'],
                    ...
                    <div id="report-content-wrapper">
                        <div class="d-flex flex-column gap-3 bg-light p-3 shadow-sm">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body row g-3 row-cols-1 row-cols-lg-2">
                                    <div class="col">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body row g-3 row-cols-1 row-cols-lg-2 align-items-stretch">
